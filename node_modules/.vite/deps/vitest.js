...
var inspectCustom = (value, options, type4) => {
...
function inspect(value, opts = {}) {
  ...
  if (type4 === "object") {
    type4 = toString.call(value).slice(8, -1);
  }
  if (type4 in baseTypesMap) {
...
function p(n2 = false) {
  let e = C(n2), i = (r2, t2, c2, o) => {
    let l3 = "", s2 = 0;
    do
      l3 += r2.substring(s2, o) + c2, s2 = o + t2.length, o = r2.indexOf(t2, s2);
    while (~o);
    return l3 + r2.substring(s2);
  }, g = (r2, t2, c2 = r2) => {
    let o = (l3) => {
      let s2 = String(l3), b2 = s2.indexOf(t2, r2.length);
      return ~b2 ? r2 + i(s2, t2, c2, b2) + t2 : r2 + s2 + t2;
    };
    return o.open = r2, o.close = t2, o;
  }, u3 = {
    isColorSupported: e
  }, d3 = (r2) => `\x1B[${r2}m`;
  for (let [r2, t2] of h)
...
function printListItems(list, config2, indentation, depth, refs, printer2) {
  ...
  const isDataView = (l3) => l3 instanceof DataView;
...
function printElement(type4, printedProps, printedChildren, config2, indentation) {
  const tagColor = config2.colors.tag;
  return `${tagColor.open}<${type4}${printedProps && tagColor.close + printedProps + config2.spacingOuter + indentation + tagColor.open}${printedChildren ? `>${tagColor.close}${printedChildren}${config2.spacingOuter}${indentation}${tagColor.open}</${type4}` : `${printedProps && !config2.min ? "" : " "}/`}>${tagColor.close}`;
}
function printElementAsLeaf(type4, config2) {
  const tagColor = config2.colors.tag;
  return `${tagColor.open}<${type4}${tagColor.close} …${tagColor.open} />${tagColor.close}`;
}
var ELEMENT_NODE = 1;
var TEXT_NODE = 3;
var COMMENT_NODE = 8;
...
var serialize$3 = (node, config2, indentation, depth, refs, printer2) => {
  ...
  const type4 = nodeIsFragment(node) ? "DocumentFragment" : node.tagName.toLowerCase();
  if (++depth > config2.maxDepth) {
    return printElementAsLeaf(type4, config2);
  }
  return printElement(
    type4,
    printProps(
...
var SPACE = " ";
var LAZY = "…";
function printImmutableEntries(val, config2, indentation, depth, refs, printer2, type4) {
  return ++depth > config2.maxDepth ? printAsLeaf(getImmutableName(type4)) : `${getImmutableName(type4) + SPACE}{${printIteratorEntries(
    val.entries(),
    config2,
    indentation,
    depth,
...
function printImmutableValues(val, config2, indentation, depth, refs, printer2, type4) {
  return ++depth > config2.maxDepth ? printAsLeaf(getImmutableName(type4)) : `${getImmutableName(type4) + SPACE}[${printIteratorValues(
    val.values(),
    config2,
    indentation,
    depth,
...
function getType2(element) {
  const type4 = element.type;
  if (typeof type4 === "string") {
    return type4;
  }
  if (typeof type4 === "function") {
    return type4.displayName || type4.name || "Unknown";
  }
  ...
  if (typeof type4 === "object" && type4 !== null) {
    ...
    if (reactIsExports.isForwardRef(element)) {
      if (type4.displayName) {
        return type4.displayName;
      }
      const functionName3 = type4.render.displayName || type4.render.name || "";
      return functionName3 === "" ? "ForwardRef" : `ForwardRef(${functionName3})`;
    }
    if (reactIsExports.isMemo(element)) {
      const functionName3 = type4.displayName || type4.type.displayName || type4.type.name || "";
      return functionName3 === "" ? "Memo" : `Memo(${functionName3})`;
    }
  }
  return "UNDEFINED";
}
...
var serialize$1 = (element, config2, indentation, depth, refs, printer2) => ++depth > config2.maxDepth ? printElementAsLeaf(getType2(element), config2) : printElement(
  getType2(element),
  printProps(
    ...
    switch (x2) {
      ...
      case "%j":
        try {
          ...
          if (
            // chromium
            m4.includes("circular structure") || m4.includes("cyclic structures") || m4.includes("cyclic object")
          ) {
            return "[Circular]";
          }
          throw err;
...
function objDisplay(obj, options = {}) {
  ...
  const type4 = Object.prototype.toString.call(obj);
...
var extendPathsF = (d3, aEnd, bEnd, bF, isCommon, aIndexesF, iMaxF) => {
  let iF = 0;
  let kF = -d3;
...
var extendPathsR = (d3, aStart, bStart, bR, isCommon, aIndexesR, iMaxR) => {
  let iR = 0;
  let kR = d3;
...
var extendOverlappablePathsF = (d3, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, iMaxF, aIndexesR, iMaxR, division) => {
...
var extendOverlappablePathsR = (d3, aStart, aEnd, bStart, bEnd, isCommon, aIndexesF, iMaxF, aIndexesR, iMaxR, division) => {
  const bR = bEnd - aEnd;
  const aLength = aEnd - aStart;
  const bLength = bEnd - bStart;
  const baDeltaLength = bLength - aLength;
...
var validateCallback = (name, arg) => {
  ...
  if (type4 !== "function") {
    throw new TypeError(`${pkg}: ${name} typeof ${type4} is not a function`);
  }
};
...
function printAnnotation({
  ...
  const a4 = `${aIndicator} ${aAnnotation}${aRest}`;
...
function diffStrings(a4, b2, options) {
  const truncate3 = (options == null ? void 0 : options.truncateThreshold) ?? false;
  const truncateThreshold = Math.max(
    Math.floor((options == null ? void 0 : options.truncateThreshold) ?? 0),
    0
  );
  let aLength = a4.length;
  let bLength = b2.length;
  if (truncate3) {
    const aMultipleLines = a4.includes("\n");
    const bMultipleLines = b2.includes("\n");
    const aNewLineSymbol = getNewLineSymbol(a4);
    const bNewLineSymbol = getNewLineSymbol(b2);
    const _a10 = aMultipleLines ? `${a4.split(aNewLineSymbol, truncateThreshold).join(aNewLineSymbol)}
` : a4;
...
` : b2;
  ...
  const truncated = aLength !== a4.length || bLength !== b2.length;
  const isCommon = (aIndex2, bIndex2) => a4[aIndex2] === b2[bIndex2];
  let aIndex = 0;
  let bIndex = 0;
  const diffs = [];
  const foundSubsequence = (nCommon, aCommon, bCommon) => {
    if (aIndex !== aCommon) {
      diffs.push(new Diff(DIFF_DELETE, a4.slice(aIndex, aCommon)));
    }
    if (bIndex !== bCommon) {
  ...
  _default(aLength, bLength, isCommon, foundSubsequence);
  if (aIndex !== aLength) {
    diffs.push(new Diff(DIFF_DELETE, a4.slice(aIndex)));
  }
  if (bIndex !== bLength) {
...
function diffStringsUnified(a4, b2, options) {
  if (a4 !== b2 && a4.length !== 0 && b2.length !== 0) {
    const isMultiline = a4.includes("\n") || b2.includes("\n");
...
` : b2,
  ...
  return diffLinesUnified(a4.split("\n"), b2.split("\n"), options);
}
function diffStringsRaw(a4, b2, cleanup, options) {
  const [diffs, truncated] = diffStrings(a4, b2, options);
  if (cleanup) {
...
function diff(a4, b2, options) {
  if (Object.is(a4, b2)) {
    return "";
  }
  const aType = getType3(a4);
  let expectedType = aType;
  let omitDifference = false;
  if (aType === "object" && typeof a4.asymmetricMatch === "function") {
    if (a4.$$typeof !== Symbol.for("jest.asymmetricMatcher")) {
      return void 0;
    }
    if (typeof a4.getExpectedType !== "function") {
      return void 0;
    }
    expectedType = a4.getExpectedType();
    omitDifference = expectedType === "string";
  }
  if (expectedType !== getType3(b2)) {
    const { aAnnotation, aColor, aIndicator, bAnnotation, bColor, bIndicator } = normalizeDiffOptions(options);
    const formatOptions = getFormatOptions(FALLBACK_FORMAT_OPTIONS, options);
    const aDisplay = format(a4, formatOptions);
...
${bDiff}`;
  ...
  switch (aType) {
    ...
    case "boolean":
    case "number":
      return comparePrimitive(a4, b2, options);
    case "map":
      return compareObjects(sortMap(a4), sortMap(b2), options);
    case "set":
      return compareObjects(sortSet(a4), sortSet(b2), options);
    default:
      return compareObjects(a4, b2, options);
  }
}
function comparePrimitive(a4, b2, options) {
  const aFormat = format(a4, FORMAT_OPTIONS);
...
function compareObjects(a4, b2, options) {
  let difference;
  let hasThrown = false;
  try {
    const formatOptions = getFormatOptions(FORMAT_OPTIONS, options);
    difference = getObjectsDifference(a4, b2, formatOptions, options);
  } catch {
    hasThrown = true;
  }
...
function getObjectsDifference(a4, b2, formatOptions, options) {
  const formatOptionsZeroIndent = { ...formatOptions, indent: 0 };
  const aCompare = format(a4, formatOptionsZeroIndent);
...
function isAsymmetricMatcher(data) {
  const type4 = getType(data);
  return type4 === "Object" && typeof data.asymmetricMatch === "function";
}
...
function printReceived(object2) {
  return f2.red(replaceTrailingSpaces(stringify(object2)));
}
...
function getCommonAndChangedSubstrings(diffs, op, hasCommonDiff2) {
  return diffs.reduce(
    (reduced, diff2) => reduced + (diff2[0] === DIFF_EQUAL ? diff2[1] : diff2[0] === op ? hasCommonDiff2 ? f2.inverse(diff2[1]) : diff2[1] : ""),
    ""
  );
}
...
function collectTask(task) {
  var _a10;
  (_a10 = collectorContext.currentSuite) == null ? void 0 : _a10.tasks.push(task);
}
  ...
  return function runWithTimeout(...args) {
    return Promise.race([
      ...
      new Promise((resolve3, reject) => {
        ...
        (_a10 = timer.unref) == null ? void 0 : _a10.call(timer);
      })
    ]);
  };
}
function createTestContext(test5, runner2) {
  ...
  return ((_a10 = runner2.extendTaskContext) == null ? void 0 : _a10.call(runner2, context)) || context;
}
...
function resolveDeps(fixtures, depSet = /* @__PURE__ */ new Set(), pendingFixtures = []) {
  fixtures.forEach((fixture) => {
    ...
    if (depSet.has(fixture)) {
      throw new Error(
        `Circular fixture dependency detected: ${fixture.prop} <- ${[...depSet].reverse().map((d3) => d3.prop).join(" <- ")}`
      );
    }
    depSet.add(fixture);
    ...
    formatted = formatted.replace(
      ...
      (_2, key) => {
        ...
        return objDisplay(objectAttr(items[0], key), {
          truncate: (_b5 = (_a10 = runner == null ? void 0 : runner.config) == null ? void 0 : _a10.chaiConfig) == null ? void 0 : _b5.truncateThreshold
        });
      }
    );
  }
...
// node_modules/vitest/dist/chunks/utils.Ck2hJTRs.js
...
var h2 = n(s.DEBUG);
var C2 = t === "test" || n(s.TEST);
var m2 = n(s.MINIMAL) || T || C2 || !R;
var a2 = /^win/i.test(I);
var M = /^linux/i.test(I);
var V = /^darwin/i.test(I);
var Y = !n(s.NO_COLOR) && (n(s.FORCE_COLOR) || (R || a2) && s.TERM !== "dumb" || T);
var _a3, _b2;
var _ = (((_b2 = (_a3 = globalThis.process) == null ? void 0 : _a3.versions) == null ? void 0 : _b2.node) || "").replace(/^v/, "") || null;
var y = Number(_ == null ? void 0 : _.split(".")[0]) || null;
...
var _a4, _b3;
var A = ((_b3 = (_a4 = globalThis.process) == null ? void 0 : _a4.release) == null ? void 0 : _b3.name) === "node";
var _a5, _b4;
var L = !!globalThis.Bun || !!((_b4 = (_a5 = globalThis.process) == null ? void 0 : _a5.versions) == null ? void 0 : _b4.bun);
var D = !!globalThis.Deno;
var O = !!globalThis.fastly;
var S = !!globalThis.Netlify;
var N = !!globalThis.EdgeRuntime;
var _a6;
var u = ((_a6 = globalThis.navigator) == null ? void 0 : _a6.userAgent) === "Cloudflare-Workers";
...
// node_modules/vitest/dist/chunks/env.CmHVDJnw.js
var _a7;
...
// node_modules/vitest/dist/chunks/index.CxRxs566.js
function getRunMode() {
...
// node_modules/vitest/dist/chunks/benchmark.C8CRJYG4.js
...
// node_modules/vitest/dist/chunks/run-once.Sxe67Wng.js
...
var _a9;
var AssertionError = (_a9 = class extends Error {
  constructor(message = "Unspecified AssertionError", props, ssf) {
    super(message);
    __publicField(this, "message");
    this.message = message;
    if (canElideFrames) {
      Error.captureStackTrace(this, ssf || _a9);
    }
...
var inspectCustom2 = __name((value, options, type32) => {
...
function inspect3(value, opts = {}) {
  ...
  if (type32 === "object") {
    type32 = toString3.call(value).slice(8, -1);
  }
...
function compareByInspect(a4, b2) {
  return inspect22(a4) < inspect22(b2) ? -1 : 1;
}
...
function SameValueZero(a4, b2) {
  return isNaN22(a4) && isNaN22(b2) || a4 === b2;
}
...
assert2.typeOf = function(val, type32, msg) {
  new Assertion(val, msg, assert2.typeOf, true).to.be.a(type32);
};
assert2.notTypeOf = function(value, type32, message) {
  new Assertion(value, message, assert2.notTypeOf, true).to.not.be.a(type32);
};
assert2.instanceOf = function(val, type32, msg) {
  new Assertion(val, msg, assert2.instanceOf, true).to.be.instanceOf(type32);
};
assert2.notInstanceOf = function(val, type32, msg) {
  new Assertion(val, msg, assert2.notInstanceOf, true).to.not.be.instanceOf(type32);
};
...
var K2 = (e) => (f3(e, u2, { value: { reset: () => P2(e[u2]) } }), e[u2]);
var T2 = (e) => e[u2] || K2(e);
function m3(e) {
  d2(
    y2("function", e) || y2("undefined", e),
    "cannot spy on a non-function value"
  );
  let t2 = function(...s2) {
    let r2 = T2(t2);
    r2.called = true, r2.callCount++, r2.calls.push(s2);
    let S2 = r2.next.shift();
    if (S2) {
      r2.results.push(S2);
      let [o, g] = S2;
      if (o === "ok")
    ...
    let p4, c2 = "ok", a4 = r2.results.length;
    if (r2.impl)
      try {
        new.target ? p4 = Reflect.construct(r2.impl, s2, new.target) : p4 = r2.impl.apply(this, s2), c2 = "ok";
      } catch (o) {
        throw p4 = o, c2 = "error", r2.results.push([c2, o]), o;
      }
    let R2 = [c2, p4];
    return w2(p4) && p4.then(
      (o) => r2.resolves[a4] = ["ok", o],
      (o) => r2.resolves[a4] = ["error", o]
    ), r2.results.push(R2), p4;
  };
  l2(t2, "_isMockFunction", true), l2(t2, "length", e ? e.length : 0), l2(t2, "name", e && e.name || "spy");
  let n2 = T2(t2);
  return n2.reset(), n2.impl = e, t2;
}
var k = (e, t2) => Object.getOwnPropertyDescriptor(e, t2);
var O2 = (e, t2) => {
  t2 != null && typeof t2 == "function" && t2.prototype != null && Object.setPrototypeOf(e.prototype, t2.prototype);
};
function C3(e, t2, n2) {
  d2(
    !y2("undefined", e),
  ...
  })(), S2 = k(e, s2), p4 = Object.getPrototypeOf(e), c2 = p4 && k(p4, s2), a4 = S2 || c2;
  d2(
    a4 || s2 in e,
    `${String(s2)} does not exist`
  );
  let R2 = false;
  r2 === "value" && a4 && !a4.value && a4.get && (r2 = "get", R2 = true, n2 = a4.get());
  let o;
  a4 ? o = a4[r2] : r2 !== "value" ? o = () => e[s2] : o = e[s2];
  let g = (v) => {
    let { value: M2, ...h4 } = a4 || {
      configurable: true,
      writable: true
    };
    r2 !== "value" && delete h4.writable, h4[r2] = v, f3(e, s2, h4);
  }, b2 = () => a4 ? f3(e, s2, a4) : g(o);
  n2 || (n2 = o);
  let i = m3(n2);
  r2 === "value" && O2(i, o);
  let I2 = i[u2];
  return l2(I2, "restore", b2), l2(I2, "getOriginal", () => R2 ? o() : o), l2(I2, "willCall", (v) => (I2.impl = v, i)), g(
    R2 ? () => (O2(i, n2), i) : i
  ), x.add(i), i;
}
  ...
  const mockContext = {
    ...
    get results() {
      return state.results.map(([callType, value]) => {
        const type4 = callType === "error" ? "throw" : "return";
        return { type: type4, value };
      });
    },
    get settledResults() {
      return state.resolves.map(([callType, value]) => {
        const type4 = callType === "error" ? "rejected" : "fulfilled";
        return { type: type4, value };
      });
    },
    get lastCall() {
...
function fn(implementation) {
  const enhancedSpy = enhanceSpy(C3({
...
var EXPECTED_COLOR = f2.green;
var RECEIVED_COLOR = f2.red;
var INVERTED_COLOR = f2.inverse;
var BOLD_WEIGHT = f2.bold;
var DIM_COLOR = f2.dim;
...
function equals(a4, b2, customTesters, strictCheck) {
  customTesters = customTesters || [];
  return eq(a4, b2, [], [], customTesters, strictCheck ? hasKey : hasDefinedKey);
}
var functionToString = Function.prototype.toString;
function isAsymmetric(obj) {
  return !!obj && typeof obj === "object" && "asymmetricMatch" in obj && isA("Function", obj.asymmetricMatch);
}
function asymmetricMatch(a4, b2) {
  const asymmetricA = isAsymmetric(a4);
  const asymmetricB = isAsymmetric(b2);
  if (asymmetricA && asymmetricB) {
    return void 0;
  }
  if (asymmetricA) {
    return a4.asymmetricMatch(b2);
  }
  if (asymmetricB) {
    return b2.asymmetricMatch(a4);
  }
}
function eq(a4, b2, aStack, bStack, customTesters, hasKey2) {
  let result = true;
  const asymmetricResult = asymmetricMatch(a4, b2);
  ...
  if (a4 instanceof Error && b2 instanceof Error) {
    return a4.message === b2.message;
  }
  if (typeof URL === "function" && a4 instanceof URL && b2 instanceof URL) {
    return a4.href === b2.href;
  }
  if (Object.is(a4, b2)) {
    return true;
  }
  ...
  const className2 = Object.prototype.toString.call(a4);
  ...
  switch (className2) {
    ...
    case "[object Number]":
      if (typeof a4 !== typeof b2) {
        return false;
      } else if (typeof a4 !== "object" && typeof b2 !== "object") {
        return Object.is(a4, b2);
      } else {
        return Object.is(a4.valueOf(), b2.valueOf());
      }
    case "[object Date]": {
      const numA = +a4;
      const numB = +b2;
  ...
  if (isDomNode(a4) && isDomNode(b2)) {
    return a4.isEqualNode(b2);
  }
  ...
  aStack.push(a4);
  bStack.push(b2);
  if (className2 === "[object Array]" && a4.length !== b2.length) {
    return false;
  }
  const aKeys = keys(a4, hasKey2);
  let key;
  ...
  while (size--) {
    key = aKeys[size];
    result = hasKey2(b2, key) && eq(a4[key], b2[key], aStack, bStack, customTesters, hasKey2);
    if (!result) {
      return false;
    }
  }
...
function iterableEquality(a4, b2, customTesters = [], aStack = [], bStack = []) {
  if (typeof a4 !== "object" || typeof b2 !== "object" || Array.isArray(a4) || Array.isArray(b2) || !hasIterator(a4) || !hasIterator(b2)) {
    return void 0;
  }
  ...
  const filteredCustomTesters = [
    ...customTesters.filter((t2) => t2 !== iterableEquality),
    iterableEqualityWithStack
  ];
  function iterableEqualityWithStack(a22, b22) {
    return iterableEquality(a22, b22, [...customTesters], [...aStack], [...bStack]);
  }
  if (a4.size !== void 0) {
    if (a4.size !== b2.size) {
      return false;
    } else if (isA("Set", a4) || isImmutableUnorderedSet(a4)) {
      let allFound = true;
      for (const aValue of a4) {
        if (!b2.has(aValue)) {
          let has = false;
      ...
      bStack.pop();
      return allFound;
    } else if (isA("Map", a4) || isImmutableUnorderedKeyed(a4)) {
      let allFound = true;
      for (const aEntry of a4) {
  ...
  if (!isImmutableList(a4) && !isImmutableOrderedKeyed(a4) && !isImmutableOrderedSet(a4) && !isImmutableRecord(a4)) {
...
function isObjectWithKeys(a4) {
  return isObject(a4) && !(a4 instanceof Error) && !Array.isArray(a4) && !(a4 instanceof Date);
}
function subsetEquality(object2, subset, customTesters = []) {
  const filteredCustomTesters = customTesters.filter(
    (t2) => t2 !== subsetEquality
  );
...
function typeEquality(a4, b2) {
  if (a4 == null || b2 == null || a4.constructor === b2.constructor) {
    return void 0;
  }
  return false;
}
function arrayBufferEquality(a4, b2) {
  let dataViewA = a4;
  let dataViewB = b2;
  if (!(a4 instanceof DataView && b2 instanceof DataView)) {
    if (!(a4 instanceof ArrayBuffer) || !(b2 instanceof ArrayBuffer)) {
      return void 0;
    }
    try {
      dataViewA = new DataView(a4);
...
function sparseArrayEquality(a4, b2, customTesters = []) {
  if (!Array.isArray(a4) || !Array.isArray(b2)) {
    return void 0;
  }
  const aKeys = Object.keys(a4);
  const bKeys = Object.keys(b2);
  const filteredCustomTesters = customTesters.filter(
    (t2) => t2 !== sparseArrayEquality
  );
  return equals(a4, b2, filteredCustomTesters, true) && equals(aKeys, bKeys);
}
...
function getObjectKeys(object2) {
  return [
    ...
    ...Object.getOwnPropertySymbols(object2).filter(
      (s2) => {
        var _a10;
        return (_a10 = Object.getOwnPropertyDescriptor(object2, s2)) == null ? void 0 : _a10.enumerable;
      }
    )
  ];
}
...
function recordAsyncExpect(test5, promise) {
...
function wrapSoft(utils, fn2) {
  return function(...args) {
    ...
    try {
      ...
      (_a10 = test5.result).errors || (_a10.errors = []);
...
(${stripped} matching ${stripped === 1 ? "property" : "properties"} omitted from actual)`;
  ...
  [
    {
      name: "toHaveResolved",
      condition: (spy) => spy.mock.settledResults.length > 0 && spy.mock.settledResults.some(({ type: type4 }) => type4 === "fulfilled"),
      action: "resolved"
    },
    {
      name: ["toHaveReturned", "toReturn"],
      condition: (spy) => spy.mock.calls.length > 0 && spy.mock.results.some(({ type: type4 }) => type4 !== "throw"),
      action: "called"
    }
  ...
  [
    {
      ...
      condition: (spy, times) => spy.mock.settledResults.reduce(
        (s2, { type: type4 }) => type4 === "fulfilled" ? ++s2 : s2,
        0
      ) === times,
      action: "resolved"
    },
    {
      ...
      condition: (spy, times) => spy.mock.results.reduce(
        (s2, { type: type4 }) => type4 === "throw" ? s2 : ++s2,
        0
      ) === times,
      action: "called"
    }
  ...
  [
    {
      ...
      condition: (spy, value) => spy.mock.settledResults.some(
        ({ type: type4, value: result }) => type4 === "fulfilled" && equals(value, result)
      ),
      action: "resolve"
    },
    {
      ...
      condition: (spy, value) => spy.mock.results.some(
        ({ type: type4, value: result }) => type4 === "return" && equals(value, result)
      ),
      action: "return"
    }
  ].forEach(({ name, condition, action }) => {
      ...
      const proxy = new Proxy(this, {
        get: (target, key, receiver) => {
          ...
          return (...args) => {
            ...
            return recordAsyncExpect(test5, promise);
          };
        }
      });
      return proxy;
...
var naturalCompare = function(a4, b2) {
  ...
  if ((a4 += "") != (b2 += "")) for (; codeB; ) {
    codeA = getCode(a4, posA++);
    codeB = getCode(b2, posB++);
    if (codeA < 76 && codeB < 76 && codeA > 66 && codeB > 66) {
      codeA = getCode(a4, posA, posA);
...
var naturalCompare$1 = getDefaultExportFromCjs3(naturalCompareExports);
...
var h3 = Object.entries(f4);
function a3(n2) {
  return String(n2);
}
a3.open = "";
a3.close = "";
function C4(n2 = false) {
  let e = typeof process != "undefined" ? process : void 0, i = (e == null ? void 0 : e.env) || {}, g = (e == null ? void 0 : e.argv) || [];
  return !("NO_COLOR" in i || g.includes("--no-color")) && ("FORCE_COLOR" in i || g.includes("--color") || (e == null ? void 0 : e.platform) === "win32" || n2 && i.TERM !== "dumb" || "CI" in i) || typeof window != "undefined" && !!window.chrome;
}
function p3(n2 = false) {
  let e = C4(n2), i = (r2, t2, c2, o) => {
    let l3 = "", s2 = 0;
    do
      l3 += r2.substring(s2, o) + c2, s2 = o + t2.length, o = r2.indexOf(t2, s2);
    while (~o);
...
function prepareExpected(expected) {
  function findStartIndent() {
    ...
    const objectIndent = (_a10 = matchObject == null ? void 0 : matchObject[1]) == null ? void 0 : _a10.length;
    if (objectIndent) {
      return objectIndent;
    }
    const matchText = /^\n( +)"/.exec(expected || "");
    return ((_b5 = matchText == null ? void 0 : matchText[1]) == null ? void 0 : _b5.length) || 0;
  }
...
function sortComparator$1(a4, b2) {
  return a4[0] - b2[0];
}
var schemeRegex = /^[\w+.-]+:\/\//;
var urlRegex = /^([\w+.-]+:)\/\/([^@/#?]*@)?([^:/#?]*)(:\d+)?(\/[^#?]*)?(\?[^#]*)?(#.*)?/;
...
function normalizePath(url, type4) {
  const rel = type4 <= UrlType2.RelativePath;
...
function sortComparator(a4, b2) {
  return a4[COLUMN] - b2[COLUMN];
}
var found = false;
...
function decodedMappings(map2) {
  var _a10;
  return (_a10 = cast(map2))._decoded || (_a10._decoded = decode(cast(map2)._encoded));
}
...
function parseStacktrace(stack, options = {}) {
  ...
  return stacks.map((stack2) => {
    ...
    const map2 = (_a10 = options.getSourceMap) == null ? void 0 : _a10.call(options, stack2.file);
...
function parseErrorStacktrace(e, options = {}) {
  ...
  if (options.frameFilter) {
    stackFrames = stackFrames.filter(
      (f5) => options.frameFilter(e, f5) !== false
    );
  }
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import("./magic-string.es-X22ZL3MF.js")).default;
  ...
  await Promise.all(
    Array.from(files).map(async (file) => {
      ...
      for (const snap of snaps) {
        ...
        replaceInlineSnap(code, s2, index, snap.snapshot);
      }
...
function replaceObjectSnap(code, s2, index, newSnap) {
...
function replaceInlineSnap(code, s2, currentIndex, newSnap) {
  ...
  if (!startMatch || startMatch.index !== (firstKeywordMatch == null ? void 0 : firstKeywordMatch.index)) {
    return replaceObjectSnap(code, s2, index, newSnap);
  }
...
${JSON.stringify(
      ...
      stack = ((_b5 = (_a10 = this.environment).processStackTrace) == null ? void 0 : _b5.call(_a10, _stack)) || _stack;
      stack.column--;
...
var SnapshotClient = class {
  ...
  async startCurrentRun(filepath, name, options) {
    ...
    this.name = name;
    if (((_a10 = this.snapshotState) == null ? void 0 : _a10.testFilePath) !== filepath) {
  ...
  skipTestSnapshots(name) {
    var _a10;
    (_a10 = this.snapshotState) == null ? void 0 : _a10.markSnapshotsAsCheckedForTest(name);
  }
  assert(options) {
    var _a10, _b5, _c, _d;
    const {
    ...
    if (typeof properties === "object") {
      ...
      try {
        const pass2 = ((_b5 = (_a10 = this.options).isEqual) == null ? void 0 : _b5.call(_a10, received, properties)) ?? false;
        if (!pass2) {
...
// node_modules/vitest/dist/chunks/tasks.BZnCS9aT.js
function getTestName(task, separator = " > ") {
  return getNames(task).slice(1).join(separator);
}

// node_modules/vitest/dist/chunks/base.BlXpj3e_.js
...
var MockDate = class _MockDate extends RealDate {
  constructor(y3, m4, d3, h4, M2, s2, ms) {
    super();
    let date;
    switch (arguments.length) {
      ...
      default:
        ...
        s2 = s2 || 0;
        ms = ms || 0;
        date = new RealDate(y3, m4, d3, h4, M2, s2, ms);
        break;
    }
...
// node_modules/vitest/dist/chunks/vi.D6IHiKAI.js
...
var Subset = getDefaultExportFromCjs2(chaiSubsetExports);
function recordAsyncExpect2(test5, promise) {
  if (test5 && promise instanceof Promise) {
    promise = promise.finally(() => {
      const index = test5.promises.indexOf(promise);
      if (index !== -1) {
...
var SnapshotPlugin = (chai2, utils) => {
  ...
  utils.addMethod(
    ...
    function(file, message) {
      ...
      return recordAsyncExpect2(test5, promise);
    }
  );
  utils.addMethod(
    chai2.Assertion.prototype,
    ...
    function __INLINE_SNAPSHOT__(properties, inlineSnapshot, message) {
      ...
      const test5 = utils.flag(this, "vitest-test");
      const isInsideEach = test5 && (test5.each || ((_a10 = test5.suite) == null ? void 0 : _a10.each));
      if (isInsideEach) {
        throw new Error(
...
function createExpectPoll(expect2) {
  return function poll(fn2, options = {}) {
    var _a10;
    const state = getWorkerState();
    const defaults = ((_a10 = state.config.expect) == null ? void 0 : _a10.poll) ?? {};
    const {
          ...
          return new Promise((resolve3, reject) => {
            ...
            const check = async () => {
              try {
                ...
                resolve3(await assertionFunction.call(assertion, ...args));
                clearTimeout(intervalId);
...
var sort2 = array.sort;
var slice = array.slice;
function comparator(a4, b2) {
  var aCall = a4.getCall(0);
...
function withGlobal(_global) {
  ...
  function parseTime(str) {
    ...
    const l3 = strings.length;
    let i = l3;
    let ms = 0;
    let parsed;
    if (l3 > 3 || !/^(\d\d:){0,2}\d\d?$/.test(str)) {
      throw new Error(
...
${job.error.stack.split("\n").slice(matchedLineIndex + 1).join("\n")}`;
  ...
  function compareTimers(a4, b2) {
    if (a4.callAt < b2.callAt) {
      return -1;
    }
    if (a4.callAt > b2.callAt) {
      return 1;
    }
    if (a4.immediate && !b2.immediate) {
      return -1;
    }
    if (!a4.immediate && b2.immediate) {
      return 1;
    }
    if (a4.createdAt < b2.createdAt) {
      return -1;
    }
    if (a4.createdAt > b2.createdAt) {
      return 1;
...
To automatically clean-up native timers, use \`shouldClearNativeTimers\`.`
  ...
  function uninstall(clock, config2) {
    ...
    for (i = 0, l3 = clock.methods.length; i < l3; i++) {
...
var FakeTimers = class {
  ...
  useFakeTimers() {
    ...
    if (!this._fakingTime) {
      ...
      if (((_b5 = (_a10 = this._userConfig) == null ? void 0 : _a10.toFake) == null ? void 0 : _b5.includes("nextTick")) && isChildProcess()) {
        throw new Error(
...
function createVitest() {
  ...
  const utils = {
    useFakeTimers(config2) {
      var _a10, _b5, _c, _d;
      if (isChildProcess()) {
        if (((_a10 = config2 == null ? void 0 : config2.toFake) == null ? void 0 : _a10.includes("nextTick")) || ((_d = (_c = (_b5 = workerState.config) == null ? void 0 : _b5.fakeTimers) == null ? void 0 : _c.toFake) == null ? void 0 : _d.includes("nextTick"))) {
          throw new Error(
...
// node_modules/vitest/dist/chunks/index.iyKRMe3s.js
var dist = {};
(function(exports) {
